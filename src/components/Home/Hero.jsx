  ...
  return (
    <section className="relative bg-gradient-to-br from-[#1E3A5F] via-[#2B547E] to-[#3A6FA0] overflow-hidden">
      {/* Decorative blobs — warmer and more visible.
          These use accent-vivid (the original #E8732A) rather than the AA-safe
          accent: nothing sits on top of them, and the darker orange washes out
          almost completely against this dark blue gradient. */}
      <div className="absolute inset-0" aria-hidden="true">
        <div className="absolute top-10 left-10 w-72 h-72 rounded-full bg-white/10 blur-3xl" />
        <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-accent-vivid/15 blur-3xl" />
        <div className="absolute top-1/2 left-1/3 w-64 h-64 rounded-full bg-accent-vivid/10 blur-3xl" />
